...
//emirhansaraç
  ...
  if (!kanal) {
    return message.channel.send(
      new Discord.RichEmbed()
        .setDescription("Coin kanalı zaten ayarlanmamış!")
  .setAuthor(`Hatalı Giriş`, message.author.avatarURL)
    .setFooter(`${message.author.tag} Tarafından İstendi`, message.author.avatarURL)
  .setTimestamp()     
        .setColor("RED")
  ...
  .setAuthor(`Başarılı`, message.author.avatarURL)
    .setFooter(`${message.author.tag} Tarafından İstendi`, message.author.avatarURL)
  .setTimestamp()     
    .setDescription(`Coin kanalı başarıyla sıfırlandı!`);
...
module.exports.help = {
  name: "coin-kanal-sıfırla",
  description: "coin-kanal-sıfırla",
  usage: "coin-kanal-sıfırla"
};
//emirhansaraç