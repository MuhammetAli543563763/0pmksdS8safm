...
client.on("guildMemberRemove", async member => {
  ...
  let sayı2 = await db.fetch(`davet_${d}`);
  db.add(`davet_${d}`, -1);
...
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬      
:outbox_tray: <@!${member.user.id}> **Adlı kullanıcı ayrıldı!** 
:outbox_tray: **Davet Eden: \`Bulunamadı\`**
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬`);
    return;
  } else {
...
client.on("guildMemberAdd", async member => {
  member.guild.fetchInvites().then(async guildInvites => {
    ...
    db.add(`davet_${invite.inviter.id}`, +1);
    ...
    if (!sayı) {
      ...
      sayı2 = await db.fetch(`davet_${invite.inviter.id}`);
    }

    client.channels.get(kanal).send(`
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
:inbox_tray: <@!${member.user.id}> sunucuya katıldı!
:inbox_tray: Davet eden: <@${davetçi.id}> 
:inbox_tray: Davet edenin toplam \`${sayı2}\`** daveti oldu.
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬`)
    if (!veri) return;
